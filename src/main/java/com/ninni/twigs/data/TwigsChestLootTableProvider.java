...
public class TwigsChestLootTableProvider extends LootTableProvider {
    public TwigsChestLootTableProvider(PackOutput output, CompletableFuture<HolderLookup.Provider> p_330862_) {
        super(output, Set.of(), List.of(new SubProviderEntry(TwigsChestLootSubProvider::new, LootContextParamSets.CHEST)), p_330862_);
    }
